...
> = {
  ...
  "control-boundary|button#ex3-tab-log.tab": { ratio: 1.56, required: 3.0, unverified: false },
  "control-boundary|button#ex3-tab-reg.tab": { ratio: 1.56, required: 3.0, unverified: false }
};
